...
int main() {
	...
	// shader
	Shader shader("shader/shadow/bill_phong_shadow.vs",
		"shader/shadow/bill_phong_shadow.fs");

	Shader simpleDepthShader("shader/shadow/simpleDepthShader.vs",
		"shader/shadow/simpleDepthShader.fs");
	Shader debugDepthQuad("shader/shadow/debug_quad.vs", "shader/shadow/debug_quad.fs");
